...
const FlexContent = ({ endpoint,ifExists }) => {
  ...
  return (
    <>
      ...
      >
        <div className="max-w-lg lg:max-w-none w-full md:text-center grid items-center lg:justify-center">
          ...
          <a href={url} className="flex items-center md:justify-center" target="_blank" role="button">
